...
//            ltitre.setText("Modifier une commande");
  ...
  if (this.checkFields()) {
            if (commande != null) {
                ...
                Commande p = new Commande(commande.getId(), tfNom.getText(), tfprenom.getText(), tfadressecomplet.getText(), tftelephone.getText(),tfemail.getText(),commande.getTotal());
                ...
                ServiceComImpl sp = new ServiceComImpl();
                 ServiceCartt Scart=new ServiceCartt();
                   List<Cart> LC=Scart.afficher();
                int price = 0;
                   for (Cart L : LC)
                   {
                       price+=L.getPrix();
                   ...
                   System.out.println(price);
                    Commande p = new Commande(tfNom.getText(), tfprenom.getText(), tfadressecomplet.getText(), tftelephone.getText(),tfemail.getText(),Double.parseDouble(price+""));           
            ...
            testFXMain.pStage.setScene(scene);
            testFXMain.pStage.show();
        }}
