...
public class Commande {
  ...
  //  private Product pc;
   ...
   //      private  ArrayList<Product> p;
    ...
    public Commande(int id, String nom, String prenom, String adressecomplet, String telephone, String email,Double prix) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
     ...
     public Commande( String nom, String prenom, String adressecomplet, String telephone, String email,Double prix) {
    ...
    public Commande(String nom, String prenom, String adresse, double total, String numtelephone, String email) {
        this.nom = nom;
        this.prenom = prenom;
